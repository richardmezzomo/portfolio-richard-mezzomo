...
export default function About() {
  return (
    <section className="px-6 py-6 lg:px-20 lg:py-10">
      ...
      <div className="pt-10 sm:flex sm:items-center sm:justify-between sm:gap-8 lg:flex lg:items-center lg:justify-between lg:gap-8 lg:pt-14">
        <div>
          ...
          <div className="flex flex-col gap-3 font-sans text-sm text-black sm:max-w-sm lg:max-w-xl">
            ...
            <p>
              Busco novos desafios e aprendizado em um ambiente que proporcione
              isso.
            </p>
          </div>
        </div>
